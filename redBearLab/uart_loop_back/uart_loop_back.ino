...
GattCharacteristic  tx_characteristic(service1_tx_uuid, tx_value, 1, TXRX_BUF_LEN, GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_WRITE | GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_WRITE_WITHOUT_RESPONSE );

GattCharacteristic  rx_characteristic(service1_rx_uuid, rx_value, 1, TXRX_BUF_LEN, GattCharacteristic::BLE_GATT_CHAR_PROPERTIES_NOTIFY);

GattCharacteristic *uartChars[] = {&tx_characteristic, &rx_characteristic};
...
{   //update characteristic data
    ble.updateCharacteristicValue(rx_characteristic.getValueAttribute().getHandle(), rx_buf, rx_buf_num);
